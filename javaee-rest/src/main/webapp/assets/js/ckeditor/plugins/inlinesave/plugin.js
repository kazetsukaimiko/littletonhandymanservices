CKEDITOR.plugins.add( 'inlinesave',
{
	init: function( editor )
	{
		editor.addCommand( 'inlinesave',
			{
				exec : function( editor )
				{
					...
					function addData() {
						...
						var callback = editor.element.$.saveCallback || function(editor, data) { console.log("Please add a saveCallback property to your element."); };
		...
		{
			label: 'Save edit- persisting changes',
			command: 'inlinesave',
